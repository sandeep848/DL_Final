...
def run_all_pipeline(split_type: str = "random", exp_dir: str = "experiments/exp_regnety_baseline", phase: str = "BC", epochs: int = 60):
    TOTAL_STAGES = 7
    print("\n" + "#" * 80)
    ...
    # 4. Training (60-Epoch Curriculum: 15 Ep Country + 45 Ep Joint Localization)
...
def main():
    ...
    parser.add_argument("--phase", type=str, default="BC", choices=["A", "B", "C", "BC", "all"], help="Training phase (default: BC for 15 ep Country warm-up + 45 ep Fine localization)")
